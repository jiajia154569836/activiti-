...
public class GitwayTest1 {
    ...
    public void tt() {
        ...
        System.out.println( s.split("==")[1].replace("\"","").replace("}","").replace(" ",""));
    }
    ...
    public void startProcess() {
        ...
        //当前用户的姓名
        ProcessInstance pi = processEngine.getRuntimeService().startProcessInstanceByKey("Cy", map);
...
//    流程实例ID:62501
//    流程定义ID:Cy:3:60004
//    存入实验id001流程实例ID62501
//    taskId:62506,taskName:K,assignee:null,createTime:Mon Aug 20 23:38:59 CST 2018
    ...
    public void searchTask() throws Exception {
        ...
        String taskId = "62506";
        List<String> nextTaskGroups = getNextTaskInfo(taskId);
        for(String task : nextTaskGroups)
        {
     ...
     * @throws Exception
     */
    public List<String> getNextTaskInfo(String taskId) throws Exception {
     ...
     * @return
     */
    private List<String> nextTaskDefinition(ActivityImpl activityImpl, String activityId, String elString, String processInstanceId){
        ...
        if ("userTask".equals(activityImpl.getProperty("type")) && !activityId.equals(activityImpl.getId())) {
            ...
            tasks.add(taskDefinition.getKey());
            return tasks;
        } else {
            // 获取节点所有流向线路信息
                ...
                if ("exclusiveGateway".equals(ac.getProperty("type"))) {
                    ...
                    if (outTransitionsTemp.size() == 1) {
                        System.out.println("1条");
                         tasks.add(outTransitionsTemp.get(0).getDestination().getId());
                        return tasks;
...
//                            if (isCondition(ac.getId(), StringUtils.trim(s.toString()), elString)) {
                            ...
                            System.out.println(tr1.getDestination().getId());

                             tasks.add(tr1.getDestination().getId().toString());
                           // }
                        }
                        return tasks;
                    }
                } else if ("userTask".equals(ac.getProperty("type"))) {
                    tasks.add(  ((UserTaskActivityBehavior) ((ActivityImpl) ac).getActivityBehavior()).getTaskDefinition().getKey());
                    return tasks;
                } else {
                }
            }

...
public class LeaveActivitiTest {
    ...
    public void deployProcess() {
        ...
        builder.addClasspathResource("bpmn1/请假流程(反射).bpmn20.xml");
        builder.addClasspathResource("bpmn1/start.form");
        builder.addClasspathResource("bpmn1/dept-leader-audit.form");
        builder.addClasspathResource("bpmn1/all-leader-audit.form");
    ...
    * */
    ...
    public void deployWithZip() {
        InputStream inputStream = this.getClass()  // 获取当前class对象
                ...
                .getResourceAsStream("bpmn1/bpmn1.zip"); // 获取指定文件资源流
